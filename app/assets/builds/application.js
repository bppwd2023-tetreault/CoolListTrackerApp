...
%o`, message, error2, detail);
  ...
  var test_controller_default = class extends Controller {
    greet() {
      this.outputTarget.innerHTML += `<p> ${this.wordsTarget.value}</p>`;
    }
    clear() {
      this.outputTarget.innerHTML = "";
    }
  };
  __publicField(test_controller_default, "targets", ["words", "output"]);

  // app/javascript/controllers/groups_controller.js
  var groups_controller_default = class extends Controller {
    manageUser(event) {
  ...
  __publicField(groups_controller_default, "targets", ["group", "user"]);

  // app/javascript/controllers/index.js
  application.register("hello", hello_controller_default);
  application.register("test", test_controller_default);
  application.register("groups", groups_controller_default);
